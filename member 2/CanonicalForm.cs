...
namespace LPR381.Core
{
    ...
    public class CanonicalForm
    {
        ...
        public double[,] A { get; set; } = default!;       // m x n
        public double[] b { get; set; } = default!;        // m
        public double[] c { get; set; } = default!;        // n
        public ConstraintSign[] Signs { get; set; } = default!; // m
        public VarType[] VariableTypes { get; set; } = default!; // n

        public string[] VariableNames { get; set; } = default!; // optional pretty names
